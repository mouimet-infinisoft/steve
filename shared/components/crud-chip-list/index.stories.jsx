...
import CrudChipList from './index.js'

export default {
  title: 'Components/Crud-Chip-List/CrudChipList',
  component: CrudChipList,
  subcomponents: { variants },
  argTypes: {
    // avatar: {
    //   name: 'avatar',
...
const Template = (args) => (
  <CrudChipList {...args}></CrudChipList>
);

export const ListCrudChip = Template.bind({});
